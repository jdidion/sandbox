...
var wrap = d3.select("#vis").append("svg:svg")
    .attr("width", r * 2)
    .attr("height", r * 2);
...
d3.text("tree.phyml", function(text) {
  ...
  var label = vis.selectAll("text")
      ...
      .attr("transform", function(d) { return "rotate(" + (d.x - 90) + ")translate(" + (r - 170) + ")rotate(" + (d.x < 180 ? 0 : 180) + ")"; })
